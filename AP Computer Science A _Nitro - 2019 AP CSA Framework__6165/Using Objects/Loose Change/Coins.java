public class Coins {
    ...
    public void quartersTotal(){
        System.out.println(quarters * 0.22);
    }
    ...
    public void nickelsTotal(){
        System.out.println(nickels * 0.07);
    }
    ...
    public void bankValue(){
        System.out.println(quarters * 0.22 + dimes * 0.11
                + nickels * 0.07 + pennies * 0.01);
    }
