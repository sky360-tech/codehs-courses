 ...
 *
 * Your job in this program is to teach Karel how to turn right.
 */
...
//This function has Karel turn right 90 degrees.
function turnRight(){
      karel.rotate(90);
 ...
 * Your job is simply to implement the turnRight()
 * function.
 *****************************************************/
...
//Has Karel turn left twice and then turn right
function start(){
    setupWorld();
    
    setTimeout(turnLeft, PAUSE_TIME);
    setTimeout(turnLeft, 2*PAUSE_TIME);
    setTimeout(turnRight, 3*PAUSE_TIME);
}
