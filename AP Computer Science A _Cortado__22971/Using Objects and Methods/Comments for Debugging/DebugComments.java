public class DebugComments
{
    ...
    {
        /*
        * Commenting out the code in this method will
        * stop it from being run. This can be used to 
        * help debug programs! Comment out Line 20, 
        * where the bug is, to temporarily allow the 
        * the program to run.
        */
